...
e = np.load("exp_2/e_single_exp2.npy")
r = np.load("exp_2/r_single_exp2.npy")
x = np.load("exp_2/x_single_exp2.npy")
...
for i in range(100):
    ...
    accuracy.append(acc)
    np.save("exp_2/theta_opt2_y2y3_single_GD_Newton",np.array(theta))
    np.save("exp_2/costs_opt2_y2y3_single_GD_Newton",np.array(costs))
    np.save("exp_2/accuracy2_y2y3_single_GD_Newton",np.array(accuracy))
