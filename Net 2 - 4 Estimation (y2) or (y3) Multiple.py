...
for i in range(100):
    ...
    accuracy.append(acc)
    np.save("exp_2/theta_opt2_y2_or_y3_multiple_GD_Newton",np.array(theta))
    np.save("exp_2/costs_opt2_y2_or_y3_multiple_GD_Newton",np.array(costs))
    np.save("exp_2/accuracy2_y2_or_y3_multiple_GD_Newton",np.array(accuracy))
