...
for i in range(100):
    ...
    accuracy.append(acc)
    np.save("exp_3/theta_opt3_y1_or_y2_multiple_GD_Newton",np.array(theta))
    np.save("exp_3/costs_opt3_y1_or_y2_multiple_GD_Newton",np.array(costs))
    np.save("exp_3/accuracy3_y1_or_y2_multiple_GD_Newton",np.array(accuracy))
