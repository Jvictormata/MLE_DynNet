...
e = np.load("exp_3/e_single_exp3.npy")
r = np.load("exp_3/r_single_exp3.npy")
x = np.load("exp_3/x_single_exp3.npy")
...
for i in range(100):
    ...
    accuracy.append(acc)
    np.save("exp_3/theta_opt3_y1y2_single_GD_Newton",np.array(theta))
    np.save("exp_3/costs_opt3_y1y2_single_GD_Newton",np.array(costs))
    np.save("exp_3/accuracy3_y1y2_single_GD_Newton",np.array(accuracy))
