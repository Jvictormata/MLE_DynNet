...
for i in range(100):
    ...
    accuracy.append(acc)
    np.save("exp_1/theta_opt_u1u3_multiple_GD_Newton",np.array(theta))
    np.save("exp_1/costs_opt_u1u3_multiple_GD_Newton",np.array(costs))
    np.save("exp_1/accuracy_u1u3_multiple_GD_Newton",np.array(accuracy))
